...
require any discretization as the relaxation by definition accepts continuous inputs. When available, this can be a pretty good option.
...
![image description](/images/extensions/pencil_2.png)
...
we provide a way to not only extend to continuous domains, but also onto *high-dimensional* ones. We will explore this in an upcoming post (part 2 of the series).
<hr>
